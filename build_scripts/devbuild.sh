...
BUILD_TAG=akash-tenant-build-gate-1 #Change this as required
ghprbPullId=749  # PR ID , will parametrize later
export KEY_NAME=akash # Key name , will parametrize
export env_file="/home/akash/openrc" #will parametrize
